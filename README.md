...
* **[Emergency Route Finder](https://github.com/palakpathak304-ops/emergency-route-finder)**
  * Java-based application designed to calculate optimal emergency routes using **Dijkstra's Shortest Path Algorithm**.

* **[Student Study Planner](https://github.com/palakpathak304-ops/student-study-planner)**
